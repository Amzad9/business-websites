...
export const metadata: Metadata = {
  title: 'Home',
  description: 'KiteStack delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'KiteStack',
  url: 'https://kitestack.com',
  logo: 'https://kitestack.com/logo.png',
  description: 'KiteStack - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/kitestack',
    'https://linkedin.com/company/kitestack',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://kitestack.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'KiteStack transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with KiteStack was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. KiteStack helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
