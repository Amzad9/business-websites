...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MoonStack delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MoonStack',
  url: 'https://moonstack.com',
  logo: 'https://moonstack.com/logo.png',
  description: 'MoonStack - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    ...
    'https://linkedin.com/company/moonstack',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://moonstack.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MoonStack transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MoonStack was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MoonStack helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
