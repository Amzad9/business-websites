...
export const metadata: Metadata = {
  title: 'Home',
  description: 'StackNova delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'StackNova',
  url: 'https://stacknova.com',
  logo: 'https://stacknova.com/logo.png',
  description: 'StackNova - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/stacknova',
    'https://linkedin.com/company/stacknova',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://stacknova.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'StackNova transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with StackNova was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. StackNova helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
