...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LoopCraft delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LoopCraft',
  url: 'https://loopcraft.com',
  logo: 'https://loopcraft.com/logo.png',
  description: 'LoopCraft - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/loopcraft',
    'https://linkedin.com/company/loopcraft',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://loopcraft.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LoopCraft transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LoopCraft was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LoopCraft helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
