...
export const metadata: Metadata = {
  title: 'Home',
  description: 'BrightFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'BrightFox',
  url: 'https://brightfox.com',
  logo: 'https://brightfox.com/logo.png',
  description: 'BrightFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/brightfox',
    'https://linkedin.com/company/brightfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://brightfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'BrightFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with BrightFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. BrightFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
