...
export const metadata: Metadata = {
  title: 'Home',
  description: 'HatchLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'HatchLoop',
  url: 'https://hatchloop.com',
  logo: 'https://hatchloop.com/logo.png',
  description: 'HatchLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/hatchloop',
    'https://linkedin.com/company/hatchloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://hatchloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'HatchLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with HatchLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. HatchLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
