...
export const metadata: Metadata = {
  title: 'Home',
  description: 'QuestMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'QuestMint',
  url: 'https://questmint.com',
  logo: 'https://questmint.com/logo.png',
  description: 'QuestMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/questmint',
    'https://linkedin.com/company/questmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://questmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'QuestMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with QuestMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. QuestMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
