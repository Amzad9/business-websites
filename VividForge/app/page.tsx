...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VividForge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VividForge',
  url: 'https://vividforge.com',
  logo: 'https://vividforge.com/logo.png',
  description: 'VividForge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/vividforge',
    'https://linkedin.com/company/vividforge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://vividforge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VividForge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VividForge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VividForge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
