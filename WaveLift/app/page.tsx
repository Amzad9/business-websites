...
export const metadata: Metadata = {
  title: 'Home',
  description: 'WaveLift delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'WaveLift',
  url: 'https://wavelift.com',
  logo: 'https://wavelift.com/logo.png',
  description: 'WaveLift - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/wavelift',
    'https://linkedin.com/company/wavelift',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://wavelift.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'WaveLift transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with WaveLift was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. WaveLift helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
