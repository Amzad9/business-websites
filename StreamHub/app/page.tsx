...
export const metadata: Metadata = {
  title: 'Home',
  description: 'StreamHub delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://streamhub.com/logo.png',
  description: 'StreamHub - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/streamhub',
    'https://linkedin.com/company/streamhub',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://streamhub.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'StreamHub transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with StreamHub was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. StreamHub helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
