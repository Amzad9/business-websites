...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZenithCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ZenithCart',
  url: 'https://zenithcart.com',
  logo: 'https://zenithcart.com/logo.png',
  description: 'ZenithCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zenithcart',
    'https://linkedin.com/company/zenithcart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zenithcart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZenithCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZenithCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZenithCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
