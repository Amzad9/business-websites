...
import AdaptiveFeatureSection from '@/components/AdaptiveFeatureSection'
import AdaptiveHomepageContent from '@/components/AdaptiveHomepageContent'

export const metadata: Metadata = {
  title: 'Home',
  description: 'ChainCraft delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ChainCraft',
  url: 'https://chaincraft.com',
  logo: 'https://chaincraft.com/logo.png',
  description: 'ChainCraft - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/chaincraft',
    'https://linkedin.com/company/chaincraft',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://chaincraft.com/search?q={search_term_string}',
...
export default function Home() {
  return (
    <>
      ...
      {/* Section 2: Why Choose Us - Feature Cards (Adaptive & AI-Driven) */}
      <AdaptiveFeatureSection
        title="Why Choose ChainCraft?"
        features={[
          {
            id: 'innovation',
            title: 'Innovation',
            ...
            {[
              {
                ...
                content: 'ChainCraft transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ChainCraft was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ChainCraft helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
