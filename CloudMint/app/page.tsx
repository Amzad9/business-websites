...
export const metadata: Metadata = {
  title: 'Home',
  description: 'CloudMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'CloudMint',
  url: 'https://cloudmint.com',
  logo: 'https://cloudmint.com/logo.png',
  description: 'CloudMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/cloudmint',
    'https://linkedin.com/company/cloudmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://cloudmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'CloudMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with CloudMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. CloudMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
