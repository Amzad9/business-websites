...
export const metadata: Metadata = {
  title: 'Home',
  description: 'IngotHub delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'IngotHub',
  url: 'https://ingothub.com',
  logo: 'https://ingothub.com/logo.png',
  description: 'IngotHub - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/ingothub',
    'https://linkedin.com/company/ingothub',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://ingothub.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'IngotHub transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with IngotHub was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. IngotHub helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
