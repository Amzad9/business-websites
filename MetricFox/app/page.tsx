...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MetricFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MetricFox',
  url: 'https://metricfox.com',
  logo: 'https://metricfox.com/logo.png',
  description: 'MetricFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/metricfox',
    'https://linkedin.com/company/metricfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://metricfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MetricFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MetricFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MetricFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
