...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about BoldBite and our mission to transform businesses.',
}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50 w-full">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-black mb-6 text-white">
              About <span className="text-primary-200">BoldBite</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              <div>
                ...
                <p className="text-black/80 text-lg leading-relaxed mb-4 font-semibold">
                  BoldBite was founded with a vision to revolutionize how businesses operate in the
                ...
                <p className="text-black/80 text-lg leading-relaxed font-semibold">
                  Today, BoldBite serves clients across various industries, helping them achieve
                  their goals through innovative technology and strategic thinking.
                </p>
              </div>
            </div>
            <div>
              <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-accent-500 rounded-2xl p-8 md:p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105">
                <h3 className="text-3xl md:text-4xl font-black mb-4 text-white">Our Mission</h3>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50 w-full">
          <h2 className="text-4xl md:text-5xl font-black text-center mb-16 text-black">
            Our <span className="text-primary-700">Values</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              { 
                title: 'Excellence', 
                description: 'We strive for perfection in everything we do, every single day',
                icon: '🎯',
