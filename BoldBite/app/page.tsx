...
export const metadata: Metadata = {
  title: 'Home',
  description: 'BoldBite delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'BoldBite',
  url: 'https://boldbite.com',
  logo: 'https://boldbite.com/logo.png',
  description: 'BoldBite - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/boldbite',
    'https://linkedin.com/company/boldbite',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://boldbite.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'BoldBite transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with BoldBite was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. BoldBite helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
