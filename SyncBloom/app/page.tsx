...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SyncBloom delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SyncBloom',
  url: 'https://syncbloom.com',
  logo: 'https://syncbloom.com/logo.png',
  description: 'SyncBloom - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/syncbloom',
    'https://linkedin.com/company/syncbloom',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://syncbloom.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SyncBloom transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SyncBloom was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SyncBloom helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
