...
export const metadata: Metadata = {
  title: 'Home',
  description: 'PixelBridge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'PixelBridge',
  url: 'https://pixelbridge.com',
  logo: 'https://pixelbridge.com/logo.png',
  description: 'PixelBridge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/pixelbridge',
    'https://linkedin.com/company/pixelbridge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://pixelbridge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'PixelBridge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with PixelBridge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. PixelBridge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
