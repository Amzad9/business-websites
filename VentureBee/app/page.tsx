...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VentureBee delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VentureBee',
  url: 'https://venturebee.com',
  logo: 'https://venturebee.com/logo.png',
  description: 'VentureBee - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/venturebee',
    'https://linkedin.com/company/venturebee',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://venturebee.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VentureBee transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VentureBee was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VentureBee helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
