...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LiftWave delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LiftWave',
  url: 'https://liftwave.com',
  logo: 'https://liftwave.com/logo.png',
  description: 'LiftWave - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/liftwave',
    'https://linkedin.com/company/liftwave',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://liftwave.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LiftWave transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LiftWave was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LiftWave helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
