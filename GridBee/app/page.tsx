...
export const metadata: Metadata = {
  title: 'Home',
  description: 'GridBee delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'GridBee',
  url: 'https://gridbee.com',
  logo: 'https://gridbee.com/logo.png',
  description: 'GridBee - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/gridbee',
    'https://linkedin.com/company/gridbee',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://gridbee.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'GridBee transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with GridBee was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. GridBee helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
