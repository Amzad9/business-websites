...
export const metadata: Metadata = {
  title: 'Home',
  description: 'PivotFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'PivotFox',
  url: 'https://pivotfox.com',
  logo: 'https://pivotfox.com/logo.png',
  description: 'PivotFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/pivotfox',
    'https://linkedin.com/company/pivotfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://pivotfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'PivotFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with PivotFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. PivotFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
