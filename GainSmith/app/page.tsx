...
export const metadata: Metadata = {
  title: 'Home',
  description: 'GainSmith delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'GainSmith',
  url: 'https://gainsmith.com',
  logo: 'https://gainsmith.com/logo.png',
  description: 'GainSmith - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/gainsmith',
    'https://linkedin.com/company/gainsmith',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://gainsmith.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'GainSmith transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with GainSmith was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. GainSmith helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
