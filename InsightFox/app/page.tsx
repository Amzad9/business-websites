...
export const metadata: Metadata = {
  title: 'Home',
  description: 'InsightFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'InsightFox',
  url: 'https://insightfox.com',
  logo: 'https://insightfox.com/logo.png',
  description: 'InsightFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/insightfox',
    'https://linkedin.com/company/insightfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://insightfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'InsightFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with InsightFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. InsightFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
