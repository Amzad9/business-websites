...
export const metadata: Metadata = {
  title: 'Home',
  description: 'PeakPulse delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'PeakPulse',
  url: 'https://peakpulse.com',
  logo: 'https://peakpulse.com/logo.png',
  description: 'PeakPulse - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    ...
    'https://linkedin.com/company/peakpulse',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://peakpulse.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'PeakPulse transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with PeakPulse was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. PeakPulse helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
