...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MarketBee delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MarketBee',
  url: 'https://marketbee.com',
  logo: 'https://marketbee.com/logo.png',
  description: 'MarketBee - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/marketbee',
    'https://linkedin.com/company/marketbee',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://marketbee.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MarketBee transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MarketBee was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MarketBee helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
