...
export const metadata: Metadata = {
  title: 'Home',
  description: 'WingHub delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'WingHub',
  url: 'https://winghub.com',
  logo: 'https://winghub.com/logo.png',
  description: 'WingHub - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/winghub',
    'https://linkedin.com/company/winghub',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://winghub.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'WingHub transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with WingHub was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. WingHub helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
