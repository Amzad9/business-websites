...
export const metadata: Metadata = {
  title: 'Home',
  description: 'RadiusX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'RadiusX',
  url: 'https://radiusx.com',
  logo: 'https://radiusx.com/logo.png',
  description: 'RadiusX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/radiusx',
    'https://linkedin.com/company/radiusx',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://radiusx.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'RadiusX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with RadiusX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. RadiusX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
