...
export const metadata: Metadata = {
  title: 'Home',
  description: 'EchoPeak delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'EchoPeak',
  url: 'https://echopeak.com',
  logo: 'https://echopeak.com/logo.png',
  description: 'EchoPeak - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/echopeak',
    'https://linkedin.com/company/echopeak',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://echopeak.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'EchoPeak transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with EchoPeak was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. EchoPeak helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
