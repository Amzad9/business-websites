...
export const metadata: Metadata = {
  title: 'Home',
  description: 'EdgeSpark delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'EdgeSpark',
  url: 'https://edgespark.com',
  logo: 'https://edgespark.com/logo.png',
  description: 'EdgeSpark - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/edgespark',
    'https://linkedin.com/company/edgespark',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://edgespark.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'EdgeSpark transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with EdgeSpark was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. EdgeSpark helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
