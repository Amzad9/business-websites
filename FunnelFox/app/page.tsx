...
export const metadata: Metadata = {
  title: 'Home',
  description: 'FunnelFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'FunnelFox',
  url: 'https://funnelfox.com',
  logo: 'https://funnelfox.com/logo.png',
  description: 'FunnelFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/funnelfox',
    'https://linkedin.com/company/funnelfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://funnelfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'FunnelFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with FunnelFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. FunnelFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
