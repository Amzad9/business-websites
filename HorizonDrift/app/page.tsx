...
export const metadata: Metadata = {
  title: 'Home',
  description: 'HorizonDrift delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'HorizonDrift',
  url: 'https://horizondrift.com',
  logo: 'https://horizondrift.com/logo.png',
  description: 'HorizonDrift - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/horizondrift',
    'https://linkedin.com/company/horizondrift',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://horizondrift.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'HorizonDrift transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with HorizonDrift was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. HorizonDrift helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
