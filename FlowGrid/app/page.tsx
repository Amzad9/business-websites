...
export const metadata: Metadata = {
  title: 'Home',
  description: 'FlowGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://flowgrid.com/logo.png',
  description: 'FlowGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/flowgrid',
    'https://linkedin.com/company/flowgrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://flowgrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'FlowGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with FlowGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. FlowGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
