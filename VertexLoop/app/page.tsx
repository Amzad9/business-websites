...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VertexLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VertexLoop',
  url: 'https://vertexloop.com',
  logo: 'https://vertexloop.com/logo.png',
  description: 'VertexLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/vertexloop',
    'https://linkedin.com/company/vertexloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://vertexloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VertexLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VertexLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VertexLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
