...
export const metadata: Metadata = {
  title: 'Home',
  description: 'QuickBloom delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'QuickBloom',
  url: 'https://quickbloom.com',
  logo: 'https://quickbloom.com/logo.png',
  description: 'QuickBloom - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/quickbloom',
    'https://linkedin.com/company/quickbloom',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://quickbloom.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'QuickBloom transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with QuickBloom was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. QuickBloom helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
