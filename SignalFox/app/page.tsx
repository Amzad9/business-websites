...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SignalFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SignalFox',
  url: 'https://signalfox.com',
  logo: 'https://signalfox.com/logo.png',
  description: 'SignalFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/signalfox',
    'https://linkedin.com/company/signalfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://signalfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SignalFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SignalFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SignalFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
