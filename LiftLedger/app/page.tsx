...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LiftLedger delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LiftLedger',
  url: 'https://liftledger.com',
  logo: 'https://liftledger.com/logo.png',
  description: 'LiftLedger - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/liftledger',
    'https://linkedin.com/company/liftledger',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://liftledger.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LiftLedger transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LiftLedger was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LiftLedger helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
