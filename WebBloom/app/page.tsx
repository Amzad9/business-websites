...
export const metadata: Metadata = {
  title: 'Home',
  description: 'WebBloom delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'WebBloom',
  url: 'https://webbloom.com',
  logo: 'https://webbloom.com/logo.png',
  description: 'WebBloom - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/webbloom',
    'https://linkedin.com/company/webbloom',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://webbloom.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'WebBloom transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with WebBloom was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. WebBloom helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
