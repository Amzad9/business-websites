...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SparkNest delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SparkNest',
  url: 'https://sparknest.com',
  logo: 'https://sparknest.com/logo.png',
  description: 'SparkNest - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/sparknest',
    'https://linkedin.com/company/sparknest',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://sparknest.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SparkNest transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SparkNest was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SparkNest helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
