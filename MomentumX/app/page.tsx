...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MomentumX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MomentumX',
  url: 'https://momentumx.com',
  logo: 'https://momentumx.com/logo.png',
  description: 'MomentumX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/momentumx',
    'https://linkedin.com/company/momentumx',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://momentumx.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MomentumX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MomentumX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MomentumX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
