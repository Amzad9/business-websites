...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZigZagX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ZigZagX',
  url: 'https://zigzagx.com',
  logo: 'https://zigzagx.com/logo.png',
  description: 'ZigZagX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zigzagx',
    'https://linkedin.com/company/zigzagx',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zigzagx.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZigZagX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZigZagX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZigZagX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
