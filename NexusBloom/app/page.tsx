...
export const metadata: Metadata = {
  title: 'Home',
  description: 'NexusBloom delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://nexusbloom.com/logo.png',
  description: 'NexusBloom - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    ...
    'https://linkedin.com/company/nexusbloom',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://nexusbloom.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'NexusBloom transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with NexusBloom was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. NexusBloom helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
