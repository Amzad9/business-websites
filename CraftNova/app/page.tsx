...
export const metadata: Metadata = {
  title: 'Home',
  description: 'CraftNova delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'CraftNova',
  url: 'https://craftnova.com',
  logo: 'https://craftnova.com/logo.png',
  description: 'CraftNova - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/craftnova',
    'https://linkedin.com/company/craftnova',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://craftnova.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'CraftNova transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with CraftNova was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. CraftNova helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
