...
export const metadata: Metadata = {
  title: 'Home',
  description: 'DriveLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'DriveLoop',
  url: 'https://driveloop.com',
  logo: 'https://driveloop.com/logo.png',
  description: 'DriveLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/driveloop',
    'https://linkedin.com/company/driveloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://driveloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'DriveLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with DriveLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. DriveLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
