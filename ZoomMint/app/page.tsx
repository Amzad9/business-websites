...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZoomMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ZoomMint',
  url: 'https://zoommint.com',
  logo: 'https://zoommint.com/logo.png',
  description: 'ZoomMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zoommint',
    'https://linkedin.com/company/zoommint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zoommint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZoomMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZoomMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZoomMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
