...
export const metadata: Metadata = {
  title: 'Home',
  description: 'RallyHub delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'RallyHub',
  url: 'https://rallyhub.com',
  logo: 'https://rallyhub.com/logo.png',
  description: 'RallyHub - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/rallyhub',
    'https://linkedin.com/company/rallyhub',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://rallyhub.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'RallyHub transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with RallyHub was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. RallyHub helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
