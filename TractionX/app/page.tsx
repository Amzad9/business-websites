...
export const metadata: Metadata = {
  title: 'Home',
  description: 'TractionX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'TractionX',
  url: 'https://tractionx.com',
  logo: 'https://tractionx.com/logo.png',
  description: 'TractionX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/tractionx',
    'https://linkedin.com/company/tractionx',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://tractionx.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'TractionX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with TractionX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. TractionX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
