...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LinkBloom delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LinkBloom',
  url: 'https://linkbloom.com',
  logo: 'https://linkbloom.com/logo.png',
  description: 'LinkBloom - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/linkbloom',
    'https://linkedin.com/company/linkbloom',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://linkbloom.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LinkBloom transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LinkBloom was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LinkBloom helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
