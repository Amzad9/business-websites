...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SprintFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SprintFox',
  url: 'https://sprintfox.com',
  logo: 'https://sprintfox.com/logo.png',
  description: 'SprintFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/sprintfox',
    'https://linkedin.com/company/sprintfox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://sprintfox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SprintFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SprintFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SprintFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
