...
export const metadata: Metadata = {
  title: 'Home',
  description: 'RiseLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'RiseLoop',
  url: 'https://riseloop.com',
  logo: 'https://riseloop.com/logo.png',
  description: 'RiseLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/riseloop',
    'https://linkedin.com/company/riseloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://riseloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'RiseLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with RiseLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. RiseLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
