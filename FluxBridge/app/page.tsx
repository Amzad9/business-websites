...
export const metadata: Metadata = {
  title: 'Home',
  description: 'FluxBridge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'FluxBridge',
  url: 'https://fluxbridge.com',
  logo: 'https://fluxbridge.com/logo.png',
  description: 'FluxBridge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/fluxbridge',
    'https://linkedin.com/company/fluxbridge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://fluxbridge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'FluxBridge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with FluxBridge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. FluxBridge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
