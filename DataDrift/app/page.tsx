...
export const metadata: Metadata = {
  title: 'Home',
  description: 'DataDrift delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'DataDrift',
  url: 'https://datadrift.com',
  logo: 'https://datadrift.com/logo.png',
  description: 'DataDrift - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/datadrift',
    'https://linkedin.com/company/datadrift',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://datadrift.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'DataDrift transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with DataDrift was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. DataDrift helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
