...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SlideLift delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SlideLift',
  url: 'https://slidelift.com',
  logo: 'https://slidelift.com/logo.png',
  description: 'SlideLift - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/slidelift',
    'https://linkedin.com/company/slidelift',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://slidelift.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SlideLift transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SlideLift was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SlideLift helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
