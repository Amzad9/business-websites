...
export const metadata: Metadata = {
  title: 'Home',
  description: 'TurboFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'TurboFox',
  url: 'https://turbofox.com',
  logo: 'https://turbofox.com/logo.png',
  description: 'TurboFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/turbofox',
    'https://linkedin.com/company/turbofox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://turbofox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'TurboFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with TurboFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. TurboFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
