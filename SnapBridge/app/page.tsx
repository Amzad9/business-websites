...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SnapBridge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SnapBridge',
  url: 'https://snapbridge.com',
  logo: 'https://snapbridge.com/logo.png',
  description: 'SnapBridge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/snapbridge',
    'https://linkedin.com/company/snapbridge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://snapbridge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SnapBridge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SnapBridge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SnapBridge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
