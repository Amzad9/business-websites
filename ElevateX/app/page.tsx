...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ElevateX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://elevatex.com/logo.png',
  description: 'ElevateX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/elevatex',
    'https://linkedin.com/company/elevatex',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://elevatex.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ElevateX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ElevateX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ElevateX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
