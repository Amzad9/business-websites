...
export const metadata: Metadata = {
  title: 'Home',
  description: 'HoverCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'HoverCart',
  url: 'https://hovercart.com',
  logo: 'https://hovercart.com/logo.png',
  description: 'HoverCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/hovercart',
    'https://linkedin.com/company/hovercart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://hovercart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'HoverCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with HoverCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. HoverCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
