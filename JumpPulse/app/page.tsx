...
export const metadata: Metadata = {
  title: 'Home',
  description: 'JumpPulse delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'JumpPulse',
  url: 'https://jumppulse.com',
  logo: 'https://jumppulse.com/logo.png',
  description: 'JumpPulse - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/jumppulse',
    'https://linkedin.com/company/jumppulse',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://jumppulse.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'JumpPulse transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with JumpPulse was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. JumpPulse helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
