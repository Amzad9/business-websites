...
export const metadata: Metadata = {
  title: 'Home',
  description: 'GrowthMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'GrowthMint',
  url: 'https://growthmint.com',
  logo: 'https://growthmint.com/logo.png',
  description: 'GrowthMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/growthmint',
    'https://linkedin.com/company/growthmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://growthmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'GrowthMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with GrowthMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. GrowthMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
