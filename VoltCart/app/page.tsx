...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VoltCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VoltCart',
  url: 'https://voltcart.com',
  logo: 'https://voltcart.com/logo.png',
  description: 'VoltCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/voltcart',
    'https://linkedin.com/company/voltcart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://voltcart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VoltCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VoltCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VoltCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
