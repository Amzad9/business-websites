...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VaultGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VaultGrid',
  url: 'https://vaultgrid.com',
  logo: 'https://vaultgrid.com/logo.png',
  description: 'VaultGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/vaultgrid',
    'https://linkedin.com/company/vaultgrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://vaultgrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VaultGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VaultGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VaultGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
