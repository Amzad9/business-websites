...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZestForge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ZestForge',
  url: 'https://zestforge.com',
  logo: 'https://zestforge.com/logo.png',
  description: 'ZestForge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zestforge',
    'https://linkedin.com/company/zestforge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zestforge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZestForge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZestForge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZestForge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
