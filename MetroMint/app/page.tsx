...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MetroMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MetroMint',
  url: 'https://metromint.com',
  logo: 'https://metromint.com/logo.png',
  description: 'MetroMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/metromint',
    'https://linkedin.com/company/metromint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://metromint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MetroMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MetroMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MetroMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
