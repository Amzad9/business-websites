...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZipGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ZipGrid',
  url: 'https://zipgrid.com',
  logo: 'https://zipgrid.com/logo.png',
  description: 'ZipGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zipgrid',
    'https://linkedin.com/company/zipgrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zipgrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZipGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZipGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZipGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
