...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ZenLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://zenloop.com/logo.png',
  description: 'ZenLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/zenloop',
    'https://linkedin.com/company/zenloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://zenloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ZenLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ZenLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ZenLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
