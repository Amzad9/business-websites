...
export const metadata: Metadata = {
  title: 'Home',
  description: 'RankSpark delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'RankSpark',
  url: 'https://rankspark.com',
  logo: 'https://rankspark.com/logo.png',
  description: 'RankSpark - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/rankspark',
    'https://linkedin.com/company/rankspark',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://rankspark.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'RankSpark transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with RankSpark was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. RankSpark helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
