...
export const metadata: Metadata = {
  title: 'Home',
  description: 'StackGlow delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'StackGlow',
  url: 'https://stackglow.com',
  logo: 'https://stackglow.com/logo.png',
  description: 'StackGlow - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/stackglow',
    'https://linkedin.com/company/stackglow',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://stackglow.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'StackGlow transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with StackGlow was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. StackGlow helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
