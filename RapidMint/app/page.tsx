...
export const metadata: Metadata = {
  title: 'Home',
  description: 'RapidMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'RapidMint',
  url: 'https://rapidmint.com',
  logo: 'https://rapidmint.com/logo.png',
  description: 'RapidMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/rapidmint',
    'https://linkedin.com/company/rapidmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://rapidmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'RapidMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with RapidMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. RapidMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
