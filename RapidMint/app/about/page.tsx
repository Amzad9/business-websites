...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about RapidMint and our mission to transform businesses.',
}
    ...
    <div className="pt-20 min-h-screen">
      <section className="py-20 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <h1 className="text-5xl font-bold text-center mb-6">About RapidMint</h1>
          </div>
          <div>
            ...
            <div>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  RapidMint was founded with a vision to revolutionize how businesses operate in the
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Today, RapidMint serves clients across various industries, helping them achieve
