...
export const metadata: Metadata = {
  title: 'Home',
  description: 'StartMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'StartMint',
  url: 'https://startmint.com',
  logo: 'https://startmint.com/logo.png',
  description: 'StartMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/startmint',
    'https://linkedin.com/company/startmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://startmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'StartMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with StartMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. StartMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
