...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-screen z-10 flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-indigo-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>

        {/* Geometric Shapes */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-32 h-32 border-4 border-blue-400/20 rotate-45"></div>
          <div className="absolute bottom-1/4 right-1/4 w-24 h-24 border-4 border-cyan-400/20 rotate-12"></div>
          <div className="absolute top-1/2 right-1/3 w-16 h-16 border-4 border-indigo-400/20 rotate-45"></div>
        </div>
        
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50 pb-16">
          <div className="text-center max-w-6xl mx-auto">
            <h1 className="text-5xl md:text-9xl mt-4 font-black mb-8 leading-tight text-white">
              BYTEBLOOM
            </h1>
            
            <FadeIn delay={0.4}>
              <p className="text-lg md:text-4xl mb-6 font-bold text-white leading-tight">
                Where Ideas Blossom into
              </p>
              <p className="text-lg md:text-4xl mb-12 font-bold text-white">
                Digital Excellence
              </p>
            </FadeIn>
            
            <FadeIn delay={0.6}>
              <p className="text-base md:text-2xl mb-12 text-white font-semibold leading-relaxed">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
                    ...
                    <div className="text-2xl md:text-7xl font-black bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mb-2">
                      {stat.number}
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50">
          <FadeIn>
            <div className="text-center mb-20">
              ...
              <p className="text-base md:text-2xl text-gray-600 font-semibold max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <FadeIn key={index} delay={index * 0.1}>
                <div className={`group relative ${service.bgColor} rounded-3xl p-8 border-4 border-transparent hover:border-gray-900 transition-all duration-500 hover:scale-105 hover:shadow-2xl overflow-hidden h-full flex flex-col`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-700 font-semibold leading-relaxed flex-grow">
                      {service.description}
                    </p>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50">
          <FadeIn>
            <div className="text-center mb-20">
              ...
              <p className="text-base md:text-2xl text-gray-600 font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  bgTo: 'to-indigo-700',
                  textFrom: 'from-indigo-300',
                  textTo: 'to-indigo-100',
                },
                {
                  step: '04',
                  title: 'Deliver',
                ...
                <FadeIn key={index} delay={index * 0.2}>
                  <div className="relative group h-full">
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.bgFrom} ${item.bgTo} rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500`}></div>
                    <div className={`relative bg-gradient-to-br ${item.bgFrom} ${item.bgTo} rounded-3xl p-8 border-4 border-transparent hover:border-white/30 transition-all duration-500 hover:scale-105 h-full flex flex-col shadow-xl`}>
                      <div className={`text-2xl font-black mb-4 bg-gradient-to-r ${item.textFrom} ${item.textTo} bg-clip-text text-transparent`}>
                        {item.step}
                      </div>
                      <h3 className="text-xl md:text-3xl font-black mb-4 text-white">
                        {item.title}
                      </h3>
                      <p className="text-white font-semibold leading-relaxed flex-grow">
                        {item.description}
                      </p>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-50">
          <FadeIn>
            <div className="text-center">
              ...
              <p className="text-lg md:text-3xl mb-12 text-white font-bold leading-relaxed max-w-4xl mx-auto">
