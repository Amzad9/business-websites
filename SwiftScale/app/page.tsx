...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SwiftScale delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SwiftScale',
  url: 'https://swiftscale.com',
  logo: 'https://swiftscale.com/logo.png',
  description: 'SwiftScale - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/swiftscale',
    'https://linkedin.com/company/swiftscale',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://swiftscale.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SwiftScale transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SwiftScale was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SwiftScale helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
