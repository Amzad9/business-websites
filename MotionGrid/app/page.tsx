...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MotionGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MotionGrid',
  url: 'https://motiongrid.com',
  logo: 'https://motiongrid.com/logo.png',
  description: 'MotionGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/motiongrid',
    'https://linkedin.com/company/motiongrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://motiongrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MotionGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MotionGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MotionGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
