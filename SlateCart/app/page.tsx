...
export const metadata: Metadata = {
  title: 'Home',
  description: 'SlateCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SlateCart',
  url: 'https://slatecart.com',
  logo: 'https://slatecart.com/logo.png',
  description: 'SlateCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/slatecart',
    'https://linkedin.com/company/slatecart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://slatecart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SlateCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SlateCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SlateCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
