...
export const metadata: Metadata = {
  title: 'Home',
  description: 'HiveLift delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'HiveLift',
  url: 'https://hivelift.com',
  logo: 'https://hivelift.com/logo.png',
  description: 'HiveLift - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/hivelift',
    'https://linkedin.com/company/hivelift',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://hivelift.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'HiveLift transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with HiveLift was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. HiveLift helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
