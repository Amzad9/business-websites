...
export const metadata: Metadata = {
  title: 'Home',
  description: 'MagneMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'MagneMint',
  url: 'https://magnemint.com',
  logo: 'https://magnemint.com/logo.png',
  description: 'MagneMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/magnemint',
    'https://linkedin.com/company/magnemint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://magnemint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'MagneMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with MagneMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. MagneMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
