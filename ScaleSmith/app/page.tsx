...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ScaleSmith delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ScaleSmith',
  url: 'https://scalesmith.com',
  logo: 'https://scalesmith.com/logo.png',
  description: 'ScaleSmith - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/scalesmith',
    'https://linkedin.com/company/scalesmith',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://scalesmith.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ScaleSmith transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ScaleSmith was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ScaleSmith helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
