...
export const metadata: Metadata = {
  title: 'Home',
  description: 'OrbitCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'OrbitCart',
  url: 'https://orbitcart.com',
  logo: 'https://orbitcart.com/logo.png',
  description: 'OrbitCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/orbitcart',
    'https://linkedin.com/company/orbitcart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://orbitcart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'OrbitCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with OrbitCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. OrbitCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
