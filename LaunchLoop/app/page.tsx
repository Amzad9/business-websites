...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LaunchLoop delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LaunchLoop',
  url: 'https://launchloop.com',
  logo: 'https://launchloop.com/logo.png',
  description: 'LaunchLoop - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/launchloop',
    'https://linkedin.com/company/launchloop',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://launchloop.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LaunchLoop transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LaunchLoop was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LaunchLoop helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
