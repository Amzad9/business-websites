...
export const metadata: Metadata = {
  title: 'Home',
  description: 'LuminateX delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'LuminateX',
  url: 'https://luminatex.com',
  logo: 'https://luminatex.com/logo.png',
  description: 'LuminateX - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/luminatex',
    'https://linkedin.com/company/luminatex',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://luminatex.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LuminateX transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LuminateX was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LuminateX helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
