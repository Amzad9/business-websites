...
export const metadata: Metadata = {
  title: 'Home',
  description: 'NovaForge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'NovaForge',
  url: 'https://novaforge.com',
  logo: 'https://novaforge.com/logo.png',
  description: 'NovaForge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/novaforge',
    'https://linkedin.com/company/novaforge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://novaforge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'NovaForge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with NovaForge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. NovaForge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
