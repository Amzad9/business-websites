...
export const metadata: Metadata = {
  title: 'Home',
  description: 'EmberLink delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'EmberLink',
  url: 'https://emberlink.com',
  logo: 'https://emberlink.com/logo.png',
  description: 'EmberLink - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/emberlink',
    'https://linkedin.com/company/emberlink',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://emberlink.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'EmberLink transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with EmberLink was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. EmberLink helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
