...
export const metadata: Metadata = {
  title: 'Home',
  description: 'HypeMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'HypeMint',
  url: 'https://hypemint.com',
  logo: 'https://hypemint.com/logo.png',
  description: 'HypeMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/hypemint',
    'https://linkedin.com/company/hypemint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://hypemint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'HypeMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with HypeMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. HypeMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
