...
export const metadata: Metadata = {
  title: 'Home',
  description: 'TrendMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'TrendMint',
  url: 'https://trendmint.com',
  logo: 'https://trendmint.com/logo.png',
  description: 'TrendMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/trendmint',
    'https://linkedin.com/company/trendmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://trendmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'TrendMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with TrendMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. TrendMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
