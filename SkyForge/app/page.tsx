...
const jsonLd = {
  ...
  logo: 'https://skyforge.com/logo.png',
  description: 'SkyForge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/skyforge',
    'https://linkedin.com/company/skyforge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://skyforge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'SkyForge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with SkyForge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. SkyForge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
