...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ShiftBee delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ShiftBee',
  url: 'https://shiftbee.com',
  logo: 'https://shiftbee.com/logo.png',
  description: 'ShiftBee - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/shiftbee',
    'https://linkedin.com/company/shiftbee',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://shiftbee.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ShiftBee transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ShiftBee was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ShiftBee helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
