...
export const metadata: Metadata = {
  title: 'Home',
  description: 'FuseStack delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'FuseStack',
  url: 'https://fusestack.com',
  logo: 'https://fusestack.com/logo.png',
  description: 'FuseStack - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/fusestack',
    'https://linkedin.com/company/fusestack',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://fusestack.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'FuseStack transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with FuseStack was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. FuseStack helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
