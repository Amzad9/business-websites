...
export const metadata: Metadata = {
  title: 'Home',
  description: 'FinForge delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'FinForge',
  url: 'https://finforge.com',
  logo: 'https://finforge.com/logo.png',
  description: 'FinForge - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/finforge',
    'https://linkedin.com/company/finforge',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://finforge.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'FinForge transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with FinForge was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. FinForge helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
