...
export const metadata: Metadata = {
  title: 'Home',
  description: 'ApexGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'ApexGrid',
  url: 'https://apexgrid.com',
  logo: 'https://apexgrid.com/logo.png',
  description: 'ApexGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/apexgrid',
    'https://linkedin.com/company/apexgrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://apexgrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'ApexGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with ApexGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. ApexGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
