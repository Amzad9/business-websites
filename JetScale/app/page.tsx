...
export const metadata: Metadata = {
  title: 'Home',
  description: 'JetScale delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'JetScale',
  url: 'https://jetscale.com',
  logo: 'https://jetscale.com/logo.png',
  description: 'JetScale - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/jetscale',
    'https://linkedin.com/company/jetscale',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://jetscale.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'JetScale transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with JetScale was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. JetScale helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
