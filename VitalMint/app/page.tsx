...
export const metadata: Metadata = {
  title: 'Home',
  description: 'VitalMint delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'VitalMint',
  url: 'https://vitalmint.com',
  logo: 'https://vitalmint.com/logo.png',
  description: 'VitalMint - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/vitalmint',
    'https://linkedin.com/company/vitalmint',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://vitalmint.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'VitalMint transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with VitalMint was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. VitalMint helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
