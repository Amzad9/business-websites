...
export const metadata: Metadata = {
  title: 'Home',
  description: 'GlowCart delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  logo: 'https://glowcart.com/logo.png',
  description: 'GlowCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/glowcart',
    'https://linkedin.com/company/glowcart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://glowcart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'GlowCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with GlowCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. GlowCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
