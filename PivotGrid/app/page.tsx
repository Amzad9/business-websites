...
export const metadata: Metadata = {
  title: 'Home',
  description: 'PivotGrid delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'PivotGrid',
  url: 'https://pivotgrid.com',
  logo: 'https://pivotgrid.com/logo.png',
  description: 'PivotGrid - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/pivotgrid',
    'https://linkedin.com/company/pivotgrid',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://pivotgrid.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'PivotGrid transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with PivotGrid was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. PivotGrid helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
