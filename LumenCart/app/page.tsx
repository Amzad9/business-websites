...
const jsonLd = {
  ...
  logo: 'https://lumencart.com/logo.png',
  description: 'LumenCart - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/lumencart',
    'https://linkedin.com/company/lumencart',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://lumencart.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'LumenCart transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with LumenCart was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. LumenCart helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
