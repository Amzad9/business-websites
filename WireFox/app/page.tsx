...
export const metadata: Metadata = {
  title: 'Home',
  description: 'WireFox delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'WireFox',
  url: 'https://wirefox.com',
  logo: 'https://wirefox.com/logo.png',
  description: 'WireFox - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/wirefox',
    'https://linkedin.com/company/wirefox',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://wirefox.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'WireFox transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with WireFox was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. WireFox helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
