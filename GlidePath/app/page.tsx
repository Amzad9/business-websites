...
export const metadata: Metadata = {
  title: 'Home',
  description: 'GlidePath delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'GlidePath',
  url: 'https://glidepath.com',
  logo: 'https://glidepath.com/logo.png',
  description: 'GlidePath - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/glidepath',
    'https://linkedin.com/company/glidepath',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://glidepath.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'GlidePath transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with GlidePath was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. GlidePath helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
