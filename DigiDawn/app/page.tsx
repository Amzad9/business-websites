...
export const metadata: Metadata = {
  title: 'Home',
  description: 'DigiDawn delivers cutting-edge solutions to transform your business.',
}
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'DigiDawn',
  url: 'https://digidawn.com',
  logo: 'https://digidawn.com/logo.png',
  description: 'DigiDawn - Leading web design company in India and internationally. Cutting-edge solutions to transform your business.',
  ...
  sameAs: [
    'https://twitter.com/digidawn',
    'https://linkedin.com/company/digidawn',
  ],
  aggregateRating: {
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://digidawn.com/search?q={search_term_string}',
            ...
            {[
              {
                ...
                content: 'DigiDawn transformed our digital presence completely. Their innovative approach and attention to detail exceeded our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, DesignCo',
                content: 'Working with DigiDawn was a game-changer. They delivered on time and created something truly exceptional for our business.',
                rating: 5,
              },
              {
                name: 'Emily Rodriguez',
                role: 'Marketing Director, GrowthHub',
                content: 'Professional, creative, and results-driven. DigiDawn helped us achieve our goals faster than we imagined possible.',
                rating: 5,
              },
